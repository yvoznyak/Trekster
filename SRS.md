...
Користувач у новому вікні вводить назву рахунку (input), обирає валюти (checkbox) та вводить суми (input). Внизу вікна знаходить кнопка зберегти, при натиску на яку зберігається новий рахунок :
